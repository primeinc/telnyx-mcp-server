...
async def test_claude_mcp():
    ...
    token = os.getenv(
        "TEST_JWT_TOKEN",
        "eyJhbGciOiJIUzI1NiIsInR5cCI6IkpXVCJ9.eyJzdWIiOiJjZjQ0OGQ1ZS04MDMzLTRkZjctOTJkMC0xNGJmMjI5ZGU5YjciLCJlbWFpbCI6InRlc3RAYXp1cmUuY29tIiwibmFtZSI6IlRlc3QgVXNlciIsImV4cCI6MTczNDMzNjAzNiwiaWF0IjoxNzM0MjQ5NjM2fQ.p7cDXGVxhXchJxP_U_YlJqhQMuBLi6K2IaU7x3Ywbvc",
    )
